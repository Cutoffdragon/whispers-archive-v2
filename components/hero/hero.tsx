...
export default function Hero() {
    ...
    return (
        <section className="background w-full min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center px-4 md:px-20 py-30 gap-10">
            {/* Text Column */}
    ...
    `,
                ...
                >
                    Where Forgotten Stories Go to Speak
                </h1></div>
    ...
    `,
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                    ...
                    <a href="/create" className="primaryBtn text-[clamp(1rem,1.5vw,1.25rem)] px-6 py-3 min-w-[180px]">
                        Share Your Whisper
                    </a>
                </div>
            </div>
            ...
            {/* Image Column */}
            <div className="w-full max-w-[200px] sm:max-w-[300px] md:max-w-[500px] lg:max-w-[700px] xl:max-w-[800px] z-10">
                <Image
                    src="/assets/icon.png"
                    alt="Whispers Archive Cryptid"
                    width={800}
                    height={900}
