...
export default function StoryFeature({ story }: { story: Story }) {

    return (
        <section className=" flex flex-col-reverse lg:flex-row items-center justify-evenly px-4 md:px-20 py-30 gap-10">
        {/* Image Column */}
